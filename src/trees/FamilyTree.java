...
public class FamilyTree
{
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node2 == null)
			throw new TreeException("there is no ndoe found with name2");//??? Throw TreeException with a useful message
		
		// Get ancestors of node1 and node2.
		ArrayList<TreeNode> ancestorsOf1 = node1.collectAncestorsToList();
		for(TreeNode item: ancestorsOf1)
...
//			if(ancestor == null)
//				System.out.println("Most recent common ancestor of Bilbo and Frodo is Balbo");
//			else 
